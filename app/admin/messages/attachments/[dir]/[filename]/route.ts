...
export async function GET(_req: Request, { params }: { params: { dir: string; filename: string } | Promise<{ dir: string; filename: string }> }) {
  ...
  try {
    ...
    console.error('[admin/messages/attachments] file error', e)
