...
type MonitoringPageClientProps = {
  initialData?: MonitoringPayload | null
    ...
    <main className={styles.utilityPage}>
      <div className={styles.pageHeader}>
        ...
        <div className={styles.pageActions}>
          ...
          <button className={styles.btnGhost} onClick={refreshPage} disabled={isRefreshPending}>Refresh</button>
        </div>
      </div>
      ...
      {error ? (
        <div className={`${styles.notice} ${styles.noticeError}`}>
          ...
          <button className={styles.noticeAction} onClick={refreshPage}>Retry</button>
        </div>
      ) : null}
