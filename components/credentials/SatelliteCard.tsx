    ...
    <div className={styles.stationCard}>
      ...
      <div className={styles.mediaRow}>
        <button className={styles.thumbWrap} onClick={() => setOpen(src)} aria-label="Open Satellite & Space preview">
          <Image src={src} alt="Satellite & Space preview" className={styles.licenseThumb} width={280} height={160} unoptimized={String(src).startsWith('data:') || String(src).startsWith('blob:')} />
